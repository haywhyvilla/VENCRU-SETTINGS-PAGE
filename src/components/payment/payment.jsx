            ...
            <div class="flex">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input class="w-[200%] py-2 pl-8 border-[1px] border-gray-300 rounded-lg outline-none" placeholder="billing@untitledui.com" />
                    </div>
                </div>
                ...
                <div class="mb-4">
                    {
                        cards.map((card) => (
                            <div class="p-4 mb-3 border-[1px] border-[#D6BBFB] rounded-lg flex items-start justify-between">
                                ...
                                <div class="mr-[30rem]"><h4 class="text-gray-700 text-sm font-medium">{card.cardNumber}</h4>
